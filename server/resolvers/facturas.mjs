          ...
          facturas:{
            ...
            Query:{
              ...
              await db.facturas.update({
                      id:args["id"],fecha:new Date(args["fecha"]),clave:args["clave"],clientesId:args["clientesId"],clientesId:args["clientesId"],clientesId:args["clientesId"],detallespedidos:args["detallespedidos"]
                    },
                    {
                    where:{id:args.id}
                    }
